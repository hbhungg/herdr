...
# next_tab = "prefix+n"
# last_tab = ""            # optional, unset by default; toggles to the previously active tab, tmux last-window style
...
# send_prefix = ""        # optional, unset by default; sends a literal prefix keypress to the pane, e.g. "prefix+e"
